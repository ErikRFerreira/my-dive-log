...
function DiveBackground({ coverPhotoUrl, diveType }: DiveBackgroundProps) {
  ...
  return (
    <div className="absolute left-0 right-0 top-0 h-[440px] overflow-hidden pointer-events-none z-0 md:left-[300px]">
      ...
      <div className="absolute inset-0 bg-gradient-to-b from-transparent via-slate-900/25 to-slate-900"></div>
      <div className="absolute inset-x-0 bottom-0 h-24 bg-gradient-to-b from-transparent to-slate-900"></div>
    </div>
  );
}

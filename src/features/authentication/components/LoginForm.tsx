      ...
      <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-5 w-full" noValidate>
        ...
        <div className="flex justify-end -mt-1">
          <button
            ...
            className="text-sm font-medium text-blue-400 hover:text-blue-300 transition-colors underline decoration-transparent hover:decoration-blue-400/30 underline-offset-4"
          >
            Forgot Password?
          </button>
        </div>
